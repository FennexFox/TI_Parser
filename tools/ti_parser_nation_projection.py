...
def _projection_preflight(
    ...
    for segment_index, segment in enumerate(plan.segments):
        _apply_segment(
            ...
            segment,
            context,
            defer_advisors=working.advisor_mission_schedule is not None,
        )
...
def run_projection(
    ...
    *,
    ...
    _apply_segment(state, plan.segments[0], context, defer_advisors=defer_advisors)
